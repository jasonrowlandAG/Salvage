...
class ResultsPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        status_row.addWidget(self.footer_label)
        ...
        # get long; keep it on its own row so the action buttons below can stay compact
        # at 1000px even on Windows' wider default font metrics.
        self.verify_progress_label.setSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Preferred)
        status_row.addWidget(self.verify_progress_label, 1)
        ...
        status_row.addWidget(self.thumb_progress_label, 1)
